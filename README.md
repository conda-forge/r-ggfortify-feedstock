...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-ggfortify-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-ggfortify-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-ggfortify
# for installing globally
pixi global install r-ggfortify
```
...
It is possible to list all of the versions of `r-ggfortify` available on your platform:
...
```
pixi search r-ggfortify --channel conda-forge
```
